...
--readFilesIn /mnt/isilon/cbmi/variome/zhangz/projects/simmons/fastq/C2864_1.fq.gz /mnt/isilon/cbmi/variome/zhangz/projects/simmons/fastq/C2864_2.fq.gz \
--runThreadN 8 \
...
--twopassMode None \
--outFileNamePrefix /home/zhangz/R/source/MyMethods/examples/rnaseq/star/pass_1/C2864_
